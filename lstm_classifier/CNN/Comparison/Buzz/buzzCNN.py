...
covid_fake_df = pd.read_csv('../../../archive/BuzzFeed_fake_news_content.csv')  # Fake medical news
covid_real_df = pd.read_csv('../../../archive/BuzzFeed_real_news_content.csv')  # Real medical news
