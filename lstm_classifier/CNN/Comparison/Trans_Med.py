...
print("[Tokenizer] Fitting on political corpus …")
tokenizer.fit_on_texts(policy_texts)            # 初始词表
print("[Tokenizer] Updating with medical corpus …")
tokenizer.fit_on_texts(medical_texts)  # 增量
...
# ==========================================================
fractions = [0.01, 0.02, 0.05,0.07,0.1]
