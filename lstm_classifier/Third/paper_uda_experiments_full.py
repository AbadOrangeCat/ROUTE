...
def flatten_result_for_csv(res: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # final metrics (ID)
    m = res["metrics_final"]
    out["tgt_test_acc_tau"] = m["tgt_test_id_acc"]
    out["tgt_test_bal_acc_tau"] = m["tgt_test_id_bal_acc"]
    out["tgt_test_macro_f1_tau"] = m["tgt_test_id_macro_f1"]
    out["tgt_val_acc_tau"] = m["tgt_val_id_acc"]
    out["tgt_val_macro_f1_tau"] = m["tgt_val_id_macro_f1"]
    # 0.5 metrics
    m05 = res["metrics_final_05"]
    out["tgt_test_acc_05"] = m05["tgt_test_id_acc"]
    out["tgt_test_macro_f1_05"] = m05["tgt_test_id_macro_f1"]
